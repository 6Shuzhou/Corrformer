...
class Knmi_Prep(Dataset):
    ...
    def __read_data__(self):
        self.raw_data = np.load(os.path.join(self.root_path,
                                             "prep_knmi_hourly_" + self.flag + ".npy"),
                                allow_pickle=True)  # (17519, 34040, 3)
        self.raw_time = np.load(os.path.join(self.root_path,
                                             "data_time_" + self.flag + ".npy"), allow_pickle=True)  # (17519)
        raw_data = self.raw_data
...
class Knmi_Humidity(Dataset):
    ...
    def __read_data__(self):
        self.raw_data = np.load(os.path.join(self.root_path,
                                             "humidity_knmi_hourly_" + self.flag + ".npy"),
                                allow_pickle=True)  # (17519, 34040, 3)
        self.raw_time = np.load(os.path.join(self.root_path,
                                             "data_time_" + self.flag + ".npy"), allow_pickle=True)  # (17519)
        raw_data = self.raw_data
...
class Knmi_Temp(Dataset):
    ...
    def __read_data__(self):
        self.raw_data = np.load(os.path.join(self.root_path,
                                             "temp_knmi_hourly_" + self.flag + ".npy"),
                                allow_pickle=True)  # (17519, 34040, 3)
        self.raw_time = np.load(os.path.join(self.root_path,
                                             "data_time_" + self.flag + ".npy"), allow_pickle=True)  # (17519)
        raw_data = self.raw_data
...
class Knmi_Wind_speed(Dataset):
    ...
    def __read_data__(self):
        self.raw_data = np.load(os.path.join(self.root_path,
                                             "wind_speed_knmi_hourly_" + self.flag + ".npy"),
                                allow_pickle=True) 
        self.raw_time = np.load(os.path.join(self.root_path,
                                             "data_time_" + self.flag + ".npy"), allow_pickle=True)  # (17519)
        raw_data = self.raw_data
